...
function BoardHeader() {
  ...
  function handleNameEdit(e: React.FocusEvent<HTMLHeadingElement>) {
    const name = e.currentTarget.textContent ?? '' // FIXED: Use textContent to avoid HTML entity encoding
...
function AppInner() {
  ...
  // FIXED: Added cleanup return and empty deps array to prevent memory leak
  useEffect(() => {
