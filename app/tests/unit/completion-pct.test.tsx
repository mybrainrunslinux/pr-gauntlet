...
// Mock eventBus and useSubscription
...
describe('completion-pct', () => {
  ...
  it('should calculate correct completion percentage when 8 of 10 cards are done', () => {
    const cards: Card[] = [
      ...
      { id:'c9', title:'Card 9', description:'', columnId:'col-done', assigneeId:null, labelIds:[], dueDate:null, priority:'medium', sprintId:null, createdAt:'2026-01-01', order:8 },
      { id:'c10', title:'Card 10', description:'', columnId:'col-done', assigneeId:null, labelIds:[], dueDate:null, priority:'medium', sprintId:null, createdAt:'2026-01-01', order:9 },
    ]
    ...
    expect(result.current.pct).toBe(80) // This will FAIL with buggy code (shows 0% because 'done' ID not found)
  })

  it('should calculate correct completion percentage when 5 of 7 cards are done', () => {
    const cards: Card[] = [
      { id:'c1', title:'Card 1', description:'', columnId:'col-todo', assigneeId:null, labelIds:[], dueDate:null, priority:'medium', sprintId:null, createdAt:'2026-01-01', order:0 },
      { id:'c2', title:'Card 2', description:'', columnId:'col-todo', assigneeId:null, labelIds:[], dueDate:null, priority:'medium', sprintId:null, createdAt:'2026-01-01', order:1 },
      { id:'c3', title:'Card 3', description:'', columnId:'col-done', assigneeId:null, labelIds:[], dueDate:null, priority:'medium', sprintId:null, createdAt:'2026-01-01', order:2 },
    ...
    expect(result.current.pct).toBe(71) // Should be Math.round((5/7) * 100) = 71
  })

  it('should show 0% when no cards are done', () => {
    const cards: Card[] = [
      { id:'c1', title:'Card 1', description:'', columnId:'col-todo', assigneeId:null, labelIds:[], dueDate:null, priority:'medium', sprintId:null, createdAt:'2026-01-01', order:0 },
      { id:'c2', title:'Card 2', description:'', columnId:'col-todo', assigneeId:null, labelIds:[], dueDate:null, priority:'medium', sprintId:null, createdAt:'2026-01-01', order:1 },
    ]
  ...
  it('should show 100% when all cards are done', () => {
    const cards: Card[] = [
